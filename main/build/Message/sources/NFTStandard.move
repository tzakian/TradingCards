module Sender::NFTStandard {
    ...
    public fun remove<NFTType: store + drop>(owner: address, id: &GUID::ID): NFT<NFTType> acquires NFTCollection {
    ...
    public fun destroy<NFTType: store + drop>(nft: NFT<NFTType>): NFTType {
        let NFT {
            id: _,
            type,
            content_uri: _,
